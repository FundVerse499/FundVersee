...
import { idlFactory } from './FundVerse_frontend.did.js';
export { idlFactory } from './FundVerse_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUNDVERSE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./FundVerse_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the FundVerse_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./FundVerse_frontend.did.js")._SERVICE>}
 */
export const FundVerse_frontend = createActor(canisterId);
