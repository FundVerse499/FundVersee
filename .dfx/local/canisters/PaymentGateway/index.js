...
import { idlFactory } from './PaymentGateway.did.js';
export { idlFactory } from './PaymentGateway.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PAYMENTGATEWAY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./PaymentGateway.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the PaymentGateway canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./PaymentGateway.did.js")._SERVICE>}
 */
export const PaymentGateway = createActor(canisterId);
