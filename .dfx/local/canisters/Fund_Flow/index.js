...
import { idlFactory } from './Fund_Flow.did.js';
export { idlFactory } from './Fund_Flow.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUND_FLOW;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Fund_Flow.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Fund_Flow canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Fund_Flow.did.js")._SERVICE>}
 */
export const Fund_Flow = createActor(canisterId);
