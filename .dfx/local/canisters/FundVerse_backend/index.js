...
import { idlFactory } from './FundVerse_backend.did.js';
export { idlFactory } from './FundVerse_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUNDVERSE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./FundVerse_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the FundVerse_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./FundVerse_backend.did.js")._SERVICE>}
 */
export const FundVerse_backend = createActor(canisterId);
