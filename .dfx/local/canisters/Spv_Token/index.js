...
import { idlFactory } from './Spv_Token.did.js';
export { idlFactory } from './Spv_Token.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SPV_TOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Spv_Token.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Spv_Token canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Spv_Token.did.js")._SERVICE>}
 */
export const Spv_Token = createActor(canisterId);
