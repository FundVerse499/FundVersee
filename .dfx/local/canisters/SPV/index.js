...
import { idlFactory } from './SPV.did.js';
export { idlFactory } from './SPV.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SPV;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./SPV.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the SPV canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./SPV.did.js")._SERVICE>}
 */
export const SPV = createActor(canisterId);
